...
Chaque sortie est lue par moi avant d'aller où que ce soit. Code, prose, constats, recommandations. Le modèle est rapide; je suis la barrière. Si je n'ai pas le temps de réviser, je n'ai pas le temps de m'en servir.

## 2. J'en prends connaissance et la responsabilité qui accompagne ce que j'en fais.

Une fois que j'agis sur la sortie du modèle, elle devient mienne. Si c'est faux, l'échec est à moi. Si c'est bon, le crédit est partagé mais la responsabilité ne l'est pas. « L'IA me l'a dit » n'est pas une défense.

## 3. Je déclare que j'utilise de l'IA.

Dans le travail, dans les livrables, dans les conversations avec collègues et clients. Pas d'aide silencieuse, pas de prétendre que le poli est purement le mien. La déclaration fait partie du livrable.
